...
fn problem_1() {
    ...
    println!("Function name and answer: {} {}", function_name!(), sum);
}
...
fn problem_4() {
    ...
    println!("Function name and answer: {} {}", function_name!(), largest);
}
...
fn problem_5() {
    ...
    println!("Function name and answer: {} {}", function_name!(), answer);
}
...
fn problem_7() {
    ...
    println!("Function name and answer: {} {}", function_name!(), num);
}
...
pub fn problem_11() {
    ...
    println!("Function name and answer: {} {}", function_name!(), largest_product);
}
